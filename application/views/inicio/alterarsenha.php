...
<div class="wrapper">
  ...
  <div class="content-header">
      <div class="container-fluid ">
        <div class="row mb-2">
          <div class="col-sm-6 ">
            <h1 class="m-0"><h5>Alterar Senha</h5></h1>
          </div><!-- /.col -->
                ...
                <section class="content">
                    <div class="container-fluid">
                          <div class="modal-body">
                            <div class="row col-md-12">
                              <div class="col-md-4">
                                  ...
                                  <input type="text" name="lblNome" id="lblNome" value="<?php echo $this->session->usuario_logado[0]['usuario'];?>" disabled="disabled" class="form-control"/>
                                  <input type="hidden" name="usuario" id="usuario" value="<?php echo $this->session->usuario_logado[0]['id'];?>"/>
                              </div>                     
                            </div>    
                          ...
                          <div class="modal-footer justify-content-between">
                            <button type="button" id="btnSalvar" name="btnSalvar" class="btn btn-primary btn-block" onclick="alterarSenha()">Alterar Senha</button>
                          </div>
