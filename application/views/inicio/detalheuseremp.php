    ...
    <div class="card"  style="margin:10px 20px 20px;">
      <div class="card-header alert-info">
        <div class="row col-md-12">
            <div class="col-md-8"><h3 class="card-title">Detalhes do Usuário</h3></div>
            <div class="col-md-4" align="right"><a href="javascript:history.back()" class="btn btn-primary" >Voltar</a></div>
        </div>
              ...
              <div class="row col-md-12">
                    ...
                    <div class="row col-md-12">
                      <div class="col-md-3">
                          ...
                          <input type="hidden" name="usuariouser" id="usuariouser" value="<?php echo $usuario;?>" />
                      </div>
                      <div class="col-md-3">
...
<script>
  ...
  var retorno = true;
   ...
   function alterarUsuario(){ 
      ...
      var usuarioNew = document.getElementById('usuariouser').value;

        $.ajax({
        type : 'POST',
        url : '<?php echo base_url();?>usuarios/alterarUser',
        data : {  usuarioNew : usuarioNew, status: status, idemail: idemail, usuariouser : usuariouser, idusuario : idusuario, perfil : perfil, entities_id : entities_id, appToken : appToken, sessionToken : sessionToken, nome : nome, sobrenome : sobrenome, senha : senha, email : email, phone : phone, powerBi : powerBi, grafana : grafana},
