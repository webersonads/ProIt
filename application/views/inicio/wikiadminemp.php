            ...
            <div class="card card-info card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-profile-tab2" data-toggle="pill" href="#custom-tabs-one-profile2" role="tab" aria-controls="custom-tabs-one-profile2" aria-selected="false">Usuários</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                        <ul>
                            ...
                            <li>Alterar dados dos usuários cadastrados;</li>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-one-profile2" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab2">
                    ...
                    <center><img src="<?php echo base_url();?>imgswiki/adminemp/Screenshot_20.png" /></center><br/><br/>

                    <strong>Ao clicar no link, o usuário será redirecionado para a tela principal de usuários.</strong><br/>
                    <center><img src="<?php echo base_url();?>imgswiki/adminemp/Screenshot_21.png" width="80%"/></center><br/><br/><br/>
                    ...
                    <center><img src="<?php echo base_url();?>imgswiki/adminemp/Screenshot_22.png" width="70%"/></center><br/><br/>
                    ...
                    <center><img src="<?php echo base_url();?>imgswiki/adminemp/Screenshot_23.png" width="80%"/></center><br/><br/>
