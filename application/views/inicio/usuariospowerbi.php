...
function cadUsuario(){ 
    ...
    var urlEmbed = document.getElementById("urlEmbed").value;
    
    var opcaoTexto = select.options[select.selectedIndex].text;
    const [, match] = opcaoTexto.match(/(\S+) /) || [];
    var codUsuario = select.options[select.selectedIndex].value;
    var usuario = opcaoTexto;

    var url = '<?php echo base_url();?>inicio/adduserpowerbi';
    $.ajax({
    type : 'POST',
    url : url,
    data : { idUsuario : codUsuario, usuario : usuario, urlEmbed : urlEmbed},
...
function excluirRegistro(id){ 
    ...
    var url = '<?php echo base_url();?>inicio/excluiruserPowerBi';
    $.ajax({
    type : 'POST',
    url : url,
    data : { idusuario : id},
...
<div class="wrapper">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><h5>Entidades com acesso ao Dashboard Gerencial</h5></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><button class="btn btn-info btn-block" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i>&nbsp;Nova Liberação</button></li>
            </ol>
          </div><!-- /.col -->
          <div class="col-md-12">
          </div>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <textarea name="urlEmbed" id="urlEmbed" class="form-control"></textarea>
                  ...
                  <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-primary btn-block" onclick="cadUsuario()">Incluir</button>
                  </div>
                </div>
                                  ...
                                  foreach($usuariosDash as $item):
                                    ...
                                    <tr>
                                      ...
                                      <td class="tituloTicket">
                                          ...
                                          <a href="<?php echo base_url();?>inicio/detalheuserpowerbi/<?php echo base64_encode($item['entidade']);?>" class="btn btn-sm btn-primary">Detalhe</a>
                                      </td>
                                    </tr>
                                  <?php endforeach;?>
                                </tbody>
