<?php
    ...
    function side($userPowerBi,$userAdmin,$menusGrafana,$exibemenuPowerbi,$exibemenusGrafana,$configuracoes){
      ...
      if($menusGrafana[0] > 0){
        ...
        $nome = $configuracoes[0]['nome'];
        $logo = $configuracoes[0]['logo'];
        $cor_menu_lateral = $configuracoes[0]['cor_menu_lateral'];
        $cor_menu_superior = $configuracoes[0]['cor_menu_superior'];
        $cor_texto = $configuracoes[0]['cor_texto'];

        echo  "<style>[class*=sidebar-light-] .sidebar a { color: ".$cor_texto." !important; }</style>";
        
        echo ' 
        <aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color:'.$cor_menu_lateral.' !important;"/>
          
          <div style="margin-top:5px; display: block; margin-left: auto; margin-right: auto; width:90%;">
            <a href="'.base_url().'/inicio" >
              <img src="'.base_url().'template/dist/img/'.$logo.'"  width="180px;"/>
            </a>
          </div>
            ...
            <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">';
                ...
                if($_SESSION['perfilUser'] == "proit"){
                  echo '<li class="nav-item">
                          <a href="'.base_url().'configuracoes" class="nav-link">
